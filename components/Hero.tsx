    ...
    <div className="relative min-h-[90vh] flex items-center justify-center pt-20 px-6 overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto text-center relative z-10">
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full glass mb-8 animate-bounce">
          ...
          <span className="text-xs font-semibold tracking-wider uppercase text-green-400">Operação 360°: Copy, Produto & Infra</span>
        </div>
        
        <h1 className="text-5xl md:text-8xl font-black mb-8 leading-[1.1] tracking-tight text-white">
          Transformamos sua Expertise em um <span className="gradient-text">Império Digital.</span>
        </h1>
        
        <p className="text-xl md:text-2xl text-slate-400 max-w-4xl mx-auto mb-12 leading-relaxed">
          Nós cuidamos de tudo: do desenvolvimento da sua <strong>esteira de produtos</strong> e <strong>copywriting de elite</strong> até a infraestrutura de e-mail e recuperação de vendas com o menor custo operacional do mercado.
        </p>
        ...
        <div className="mt-20 grid grid-cols-2 md:grid-cols-4 gap-8 opacity-50 grayscale hover:grayscale-0 transition-all items-center">
          <div className="text-sm font-bold tracking-widest text-slate-400">COPYWRITING ELITE</div>
          <div className="text-sm font-bold tracking-widest text-slate-400">ESTEIRA DE LTV</div>
          <div className="text-sm font-bold tracking-widest text-slate-400">LOW & HIGH TICKET</div>
          <div className="text-sm font-bold tracking-widest text-slate-400">INFRA PRÓPRIA</div>
        </div>
      </div>
    </div>
  );
