...
const Hero: React.FC = () => {
  return (
    <div className="relative min-h-[95vh] flex items-center justify-center pt-24 px-6 overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto text-center relative z-10">
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full glass mb-10 animate-fadeIn">
        ...
        <h1 className="text-6xl md:text-9xl font-black mb-8 leading-[0.95] tracking-tight text-white drop-shadow-2xl">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-6 animate-fadeIn" style={{ animationDelay: '0.2s' }}>
          <a href="#ai-diagnostic" className="w-full sm:w-auto px-12 py-5 glass text-sm font-bold rounded-2xl transition-all hover:bg-white hover:text-black uppercase tracking-widest text-white">
          ...
          <a 
            ...
            className="w-full sm:w-auto px-12 py-5 bg-blue-600 hover:bg-blue-500 text-sm font-bold rounded-2xl shadow-2xl shadow-blue-500/20 transition-all hover:-translate-y-1 uppercase tracking-widest text-white"
          >
            Falar com Estrategista
          </a>
        </div>

        <div className="mt-28 grid grid-cols-2 md:grid-cols-4 gap-12 opacity-40 grayscale hover:grayscale-0 transition-all items-center">
