    ...
    <div className="grid lg:grid-cols-12 gap-20 items-center py-24">
      <div className="lg:col-span-5 space-y-12">
        <div className="space-y-4">
          ...
          <h2 className="text-4xl md:text-7xl font-black leading-[0.9] tracking-tighter text-white uppercase italic">
        ...
        <div className="grid grid-cols-2 gap-6">
          <div className="p-8 md:p-10 rounded-[48px] glass border-white/5 group hover:border-blue-500/20 transition-all">
            <div className="text-3xl md:text-4xl font-black text-white mb-3 group-hover:text-blue-500 transition-colors tracking-tighter">100%</div>
            <div className="text-[10px] text-slate-500 font-black uppercase tracking-widest">White-Glove Service</div>
          </div>
          <div className="p-8 md:p-10 rounded-[48px] glass border-white/5 group hover:border-blue-500/20 transition-all">
            <div className="text-3xl md:text-4xl font-black text-white mb-3 group-hover:text-blue-500 transition-colors tracking-tighter">7.2x</div>
            <div className="text-[10px] text-slate-500 font-black uppercase tracking-widest">ROI Médio em Perpétuo</div>
          </div>
        </div>
      </div>
      
      <div className="lg:col-span-7 glass p-10 md:p-16 rounded-[64px] border-white/5 relative overflow-hidden h-[500px] md:h-[600px] flex flex-col justify-between shadow-4xl">
        <div className="absolute inset-0 bg-blue-500/5 blur-[120px] -z-10"></div>
        <div className="flex justify-between items-start">
          <div>
            <h3 className="text-2xl md:text-3xl font-black text-white tracking-tighter uppercase italic">Escala de Cashflow</h3>
            <p className="text-slate-500 text-sm md:text-base mt-2">Crescimento real de faturamento semanal em sistemas perpétuos</p>
          </div>
          <div className="hidden sm:block px-5 py-2.5 rounded-2xl bg-blue-500/10 border border-blue-500/20 text-blue-400 text-[10px] font-black uppercase tracking-widest">Verified Data</div>
        </div>
        
        <div className="h-[250px] md:h-[320px] mt-12">
